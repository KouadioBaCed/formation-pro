  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        // Override Tailwind's `blue` palette so any leftover
        // `bg-blue-*` / `text-blue-*` classes inherit FinMark greens.
        blue: {
          50: '#EAF6EC',
          100: '#D2EDD7',
          200: '#A6DBAF',
        ...
        // Light/mid green accent (replaces the previous cyan accent).
        cyan: {
          50: '#F2FBE6',
          100: '#E5F6CC',
          200: '#CFEC9C',
      ...
      boxShadow: {
        ...
        'card-hover': '0 10px 40px -10px rgb(0 0 0 / 0.15), 0 4px 6px -2px rgb(0 0 0 / 0.05)',
        'card-dark': '0 1px 3px 0 rgb(0 0 0 / 0.3), 0 1px 2px -1px rgb(0 0 0 / 0.3)',
        'glow': '0 0 20px rgb(63 160 85 / 0.5)',
        'glow-success': '0 0 20px rgb(63 160 85 / 0.5)',
        'glow-error': '0 0 20px rgb(239 68 68 / 0.5)',
        'glass': '0 8px 32px 0 rgba(31, 38, 135, 0.15)',
        'xl-soft': '0 20px 50px -12px rgb(0 0 0 / 0.15)',
      },
      animation: {
