...
export const section4Questions: Question[] = [
    ...
    {
        id: 76,
        question: "Quelle licence Power BI est nécessaire pour accéder aux fonctionnalités d'\"App Workspace\" ?",
    ...
    },
    {
        id: 151,
        question:
            "Vous travaillez avec votre équipe Agile pour évaluer la taille des cartes de story et les placer dans les itérations à venir. Vous remarquez que les points attribués aux cartes de story augmentent à chaque version. Pourquoi cela se produit-il ?",
        options: [
            "Le propriétaire du produit continue d'ajouter des éléments au projet.",
            "La dette technique s'accumule depuis les versions précédentes.",
            "Les membres de l'équipe ne travaillent pas toutes les heures qui leur sont attribuées.",
            "Les membres de l'équipe travaillent trop dur et sont épuisés."
        ],
        solution: "La dette technique s'accumule depuis les versions précédentes.",
        explication:
            "La dette technique augmente lorsque le code est livré sans être refactorisé, ce qui rend chaque nouvelle version plus coûteuse à développer."
    },
    {
        id: 152,
        question:
            "La responsable du projet vous demande le temps de cycle moyen et le délai moyen du projet. Que lui répondez-vous ?",
        options: [
            "La durée moyenne des congés et de présence de l'équipe.",
            "Le temps moyen des stand-ups et des rétrospectives.",
            "Le temps moyen nécessaire pour réaliser les cartes de story et les fonctionnalités.",
            "Le temps d'arrêt moyen de l'équipe et le temps de finalisation des versions."
        ],
        solution:
            "Le temps moyen nécessaire pour réaliser les cartes de story et les fonctionnalités.",
        explication:
            "Le temps de cycle concerne les cartes de story, tandis que le délai d'exécution concerne les fonctionnalités complètes."
    },
    {
        id: 153,
        question:
            "Vous examinez la vélocité de votre équipe Agile et remarquez qu'elle a augmenté au cours des deux dernières itérations. Quelle pourrait en être la raison ?",
        options: [
            "La productivité d'un membre de l'équipe a augmenté.",
            "L'équipe ne teste plus chaque carte.",
            "Les cartes ont été estimées au hasard.",
            "Le backlog a été vidé."
        ],
        solution: "La productivité d'un membre de l'équipe a augmenté.",
        explication:
            "Une amélioration de la productivité individuelle impacte la vélocité globale de l'équipe."
    },
    {
        id: 154,
        question:
            "Vous demandez au testeur qualité de suivre le temps de cycle des défauts. Que va-t-il mesurer ?",
        options: [
            "Le nombre de défauts détectés.",
            "Le temps nécessaire pour corriger un défaut après sa détection.",
            "Le nombre de cycles de tests.",
            "Le nombre de fonctionnalités impactées."
        ],
        solution:
            "Le temps nécessaire pour corriger un défaut après sa détection.",
        explication:
            "Le temps de cycle mesure la durée nécessaire pour terminer une tâche, ici la correction d'un défaut."
    },
    {
        id: 155,
        question:
            "Le testeur qualité indique qu'il existe des défauts non détectés dans la dernière fonctionnalité livrée. De quoi s'agit-il ?",
        options: [
            "Fonctionnalités incomplètes.",
            "Code nécessitant une refactorisation.",
            "Défauts échappés aux tests.",
            "Absences aux réunions quotidiennes."
        ],
        solution: "Défauts échappés aux tests.",
        explication:
            "Les défauts échappés sont ceux qui passent les tests et arrivent en production, où leur correction est plus coûteuse."
    },
    {
        id: 156,
        question:
            "Dans quel ordre un leader serviteur aborde-t-il le travail ?",
        options: [
            "Objectif, personnes, processus.",
            "Personnes, systèmes, technologie.",
            "Information, rapports, processus.",
            "Usine, personnel, machines."
        ],
        solution: "Objectif, personnes, processus.",
        explication:
            "Le leader serviteur commence par le but, soutient les personnes, puis met en place les processus."
    },
    {
        id: 157,
        question:
            "Laquelle des propositions suivantes n'est PAS une caractéristique du leadership serviteur ?",
        options: [
            "Coaching de l'équipe.",
            "Promotion de la confiance.",
            "Encourager l'énergie des autres.",
            "Forcer l'équipe à faire ce que vous dites."
        ],
        solution: "Forcer l'équipe à faire ce que vous dites.",
        explication:
            "Le leadership serviteur n'est pas directif, il favorise l'autonomie et la collaboration."
    },
    {
        id: 158,
        question:
            "Que représentent les causes communes et les causes spéciales dans Lean ?",
        options: [
            "Problèmes normaux et problèmes liés à une situation unique.",
            "Problèmes logiciels et matériels.",
            "Problèmes anciens et récents.",
            "Problèmes liés à l'intégration continue."
        ],
        solution:
            "Problèmes normaux et problèmes liés à une situation unique.",
        explication:
            "Les causes communes proviennent du fonctionnement normal, les causes spéciales de situations exceptionnelles."
    },
    {
        id: 159,
        question:
            "Quel élément ne communiqueriez-vous PAS à un nouveau Product Owner ?",
        options: [
            "Il représente le client.",
            "Il doit avoir une expérience Agile préalable.",
            "Il collabore avec les parties prenantes.",
            "Il apporte une expertise métier."
        ],
        solution:
            "Il doit avoir une expérience Agile préalable.",
        explication:
            "Un Product Owner n'a pas besoin d'une expérience Agile préalable, mais d'une expertise métier."
    },
    {
        id: 160,
        question:
            "Quel élément n'est PAS un principe de l'Agile Unified Process (AUP) ?",
        options: [
            "Adapter l'approche.",
            "S'assurer que l'équipe sait ce qu'elle fait.",
            "Accord collectif sur la portée avant livraison.",
            "Priorité aux activités à forte valeur ajoutée."
        ],
        solution:
            "Accord collectif sur la portée avant livraison.",
        explication:
            "L'AUP, comme l'Agile, s'adapte en continu sans figer la portée à l'avance."
    },
    {
        id: 161,
        question: "Quel principe fait partie des 12 principes clarificateurs Agile ?",
        options: [
            "Satisfaire le client par une livraison rapide et continue de valeur.",
            "Obtenir l’adhésion de la direction en priorité.",
            "Limiter les informations pour réduire les changements.",
            "Planifier minutieusement tout le projet."
        ],
        solution: "Satisfaire le client par une livraison rapide et continue de valeur.",
        explication: "La priorité absolue en Agile est la satisfaction du client via des livraisons continues de valeur."
    },
    {
        id: 162,
        question: "La vélocité maximale observée est 35 et minimale 25. Que faites-vous ?",
        options: [
            "Forcer l’équipe à dépasser 35.",
            "Fixer la limite WIP à 35 et ajuster si nécessaire.",
            "Ajouter plus de personnes.",
            "Réduire le backlog."
        ],
        solution: "Fixer la limite WIP à 35 et ajuster si nécessaire.",
        explication: "On se base sur la vélocité observée pour fixer un rythme durable sans surcharger l’équipe."
    },
    {
        id: 163,
        question: "Comment ajuster un backlog au risque ?",
        options: [
            "Comparer ROI et impact des risques.",
            "Prioriser uniquement par importance.",
            "Créer des cartes de risques à prioriser dans le backlog.",
            "Créer un registre des risques."
        ],
        solution: "Créer des cartes de risques à prioriser dans le backlog.",
        explication: "Les risques exploitables deviennent des éléments priorisés du backlog."
    },
    {
        id: 164,
        question: "Comment traiter les éléments à haut risque ?",
        options: [
            "Modifier les exigences.",
            "Les planifier plus tard.",
            "Les planifier plus tôt.",
            "Créer une itération spéciale risque."
        ],
        solution: "Les planifier plus tôt.",
        explication: "Traiter les risques tôt réduit leur impact futur."
    },
    {
        id: 165,
        question: "Quel élément n’est PAS conçu pour révéler et résoudre les problèmes ?",
        options: [
            "Rétrospectives",
        ...
        solution: "Rédaction des user stories",
        explication: "Les user stories servent à décrire le besoin, pas à résoudre des problèmes."
    },
    {
        id: 166,
        question: "Qu’est-ce qui n’est PAS correct concernant le facilitateur d’équipe ?",
        options: [
            "Peut être Scrum Master ou coach.",
            "Doit avoir un diplôme en commerce.",
            "Toutes les équipes ont besoin de ce rôle.",
            "Aide à supprimer les obstacles."
        ],
        solution: "Doit avoir un diplôme en commerce.",
        explication: "Le rôle repose sur la facilitation, pas sur un diplôme spécifique."
    },
    {
        id: 167,
        question: "Quel type de membres choisir pour une équipe Agile ?",
        options: [
            "Spécialistes généralistes (profil en T).",
            "Uniquement des leaders.",
            "Spécialistes des risques.",
            "Réduire l’équipe."
        ],
        solution: "Spécialistes généralistes (profil en T).",
        explication: "Les membres en T ont une spécialité et des compétences transverses."
    },
    {
        id: 168,
        question: "Qu’est-ce qui n’est PAS correct dans l’approche Whole Team ?",
        options: [
            "Inclut toutes les compétences nécessaires.",
            "Équipe de 3 à 9 personnes.",
            "Travail à 100% dédié.",
            "Les équipes ne doivent pas être polyvalentes."
        ],
        solution: "Les équipes ne doivent pas être polyvalentes.",
        explication: "La polyvalence est essentielle dans l’approche Whole Team."
    },
    {
        id: 169,
        question: "Qu’est-ce qui n’est PAS vrai concernant une équipe interfonctionnelle ?",
        options: [
            "Elle possède toutes les compétences nécessaires.",
            "Elle n’a pas besoin de gestion visuelle.",
            "Inclut dev, testeurs, designers.",
            "Réduit la dépendance externe."
        ],
        solution: "Elle n’a pas besoin de gestion visuelle.",
        explication: "La gestion visuelle est toujours utilisée en Agile."
    },
    {
        id: 170,
        question: "Le troisième rôle d’une équipe Agile est :",
        options: [
            "Créateur de l’équipe",
            "Facilitateur de l’équipe",
            "Coureur de l’équipe",
            "Observateur"
        ],
        solution: "Facilitateur de l’équipe",
        explication: "Le facilitateur (Scrum Master) aide à supprimer les obstacles."
    },
    {
        id: 171,
        question: "Une user story est bloquée par une dépendance. Que faire ?",
        options: [
            "Soulever un bloqueur immédiatement.",
            "Ignorer.",
            "Supprimer la story.",
            "Externaliser."
        ],
        solution: "Soulever un bloqueur immédiatement.",
        explication: "Les obstacles doivent être signalés rapidement à l’équipe."
    },
    {
        id: 172,
        question: "Pourquoi la sécurité psychologique est-elle importante ?",
        options: [
            "Pour blâmer les fautifs.",
            "Pour compter les défauts.",
            "Pour permettre à l’équipe de demander de l’aide.",
            "Pour répartir le travail."
        ],
        solution: "Pour permettre à l’équipe de demander de l’aide.",
        explication: "Elle favorise l’ouverture, l’amélioration et la collaboration."
    },
    {
        id: 173,
        question: "Quelle méthode Agile permet de recueillir du feedback ?",
        options: [
        ...
        solution: "Revue de sprint",
        explication: "Les revues de sprint permettent un retour direct des parties prenantes."
    },
    {
        id: 174,
        question: "Le commercial veut plus de fonctionnalités que possible. Que faire ?",
        options: [
            "Montrer la vélocité et prioriser.",
            "Ajouter des membres.",
            "Changer de représentant.",
            "Supprimer des fonctionnalités."
        ],
        solution: "Montrer la vélocité et prioriser.",
        explication: "La priorisation basée sur la vélocité protège l’équipe."
    },
    {
        id: 175,
        question: "Quel outil Agile aide à détecter les problèmes tôt ?",
        options: [
            "Plan de gestion",
            "Réunion hebdomadaire",
            "Planification itérative",
            "Gestion visuelle (Kanban, vélocité)"
        ],
        solution: "Gestion visuelle (Kanban, vélocité)",
        explication: "La gestion visuelle rend les problèmes visibles rapidement."
    },
    {
        id: 176,
        question: "Quel principe clarificateur Agile est correct ?",
        options: [
            "Adapter l’approche",
            "Rapporter souvent à la direction",
            "Livrer fréquemment des logiciels fonctionnels",
            "Tout planifier avant livraison"
        ],
        solution: "Livrer fréquemment des logiciels fonctionnels",
        explication: "Les livraisons fréquentes sont un principe clé Agile."
    },
    {
        id: 177,
        question: "Quel principe clarificateur est correct ?",
        options: [
            "Les métiers dictent tout",
            "Les développeurs travaillent seuls",
            "Ils discutent au déjeuner",
            "Métiers et développeurs travaillent ensemble quotidiennement"
        ],
        solution: "Métiers et développeurs travaillent ensemble quotidiennement",
        explication: "La collaboration quotidienne est essentielle."
    },
    {
        id: 178,
        question: "Quel principe est correct ?",
        options: [
            "Brainstorming régulier",
            "Soutien de la direction",
            "Livrer sans tester",
            "Construire autour d’individus motivés"
        ],
        solution: "Construire autour d’individus motivés",
        explication: "Agile valorise les individus motivés et autonomes."
    },
    {
        id: 179,
        question: "Meilleure méthode de communication Agile ?",
        options: [
            "Face à face",
            "Toujours écrit",
        ...
        solution: "Face à face",
        explication: "La communication en face à face est la plus efficace."
    },
    {
        id: 180,
        question: "Principale mesure du progrès en Agile ?",
        options: [
            "Participation",
        ...
        solution: "Logiciel fonctionnel",
        explication: "Le logiciel fonctionnel est la mesure du progrès."
    },
    {
        id: 181,
        question: "Comment améliorer l’équipe au fil du projet ?",
        options: [
            "Rétrospective en fin de projet",
            "Rétrospective à chaque itération",
            "Avis du PO uniquement",
            "Changer les rôles"
        ],
        solution: "Rétrospective à chaque itération",
        explication: "Les rétrospectives régulières améliorent continuellement l’équipe."
    },
    {
        id: 182,
        question: "Comment aider à comprendre les exigences ?",
        options: [
            "Plan de projet",
            "Prototype/Wireframe",
            "Calendrier",
        ...
        solution: "Prototype/Wireframe",
        explication: "Les prototypes facilitent la compréhension des exigences."
    },
    {
        id: 183,
        question: "Quels facteurs ajouter au délai total ?",
        options: [
            "Tests et fusion",
            "Réunions",
            "Temps à valeur ajoutée et non valeur ajoutée",
            "Documentation"
        ],
        solution: "Temps à valeur ajoutée et non valeur ajoutée",
        explication: "Le délai inclut tout le temps utile et inutile."
    },
    {
        id: 184,
        question: "Avantage des prototypes et maquettes ?",
        options: [
            "Éviter le vrai produit",
            "Faire une réunion",
            "Créer des formulaires",
            "Faciliter le feedback et le reporting"
        ],
        solution: "Faciliter le feedback et le reporting",
        explication: "Ils permettent d’obtenir des retours rapides des parties prenantes."
    },
    {
        id: 185,
        question: "But de la rétrospective ?",
        options: [
            "Prioriser",
            "Blâmer",
            "S’améliorer",
        ...
        solution: "S’améliorer",
        explication: "La rétrospective vise l’amélioration continue."
    },
    {
        id: 186,
        question: "Méthode décrite : qualité pour tous et autonomie ?",
        options: [
        ...
        solution: "Whole Team Approach",
        explication: "Toute l’équipe possède les compétences nécessaires."
    },
    {
        id: 187,
        question: "Comment surmonter les silos organisationnels ?",
        options: [
            "Intégrer les compétences nécessaires dans l’équipe",
            "Demande de modification",
            "Journal des problèmes",
            "Gestion des risques"
        ],
        solution: "Intégrer les compétences nécessaires dans l’équipe",
        explication: "L’approche Whole Team élimine les dépendances externes."
    },
    {
        id: 188,
        question: "Principe Agile sur le rythme de travail ?",
        options: [
            "Pas de processus",
            "Satisfaire tout le monde",
            "Rythme durable indéfiniment",
            "Pousser l’équipe"
        ],
        solution: "Rythme durable indéfiniment",
        explication: "Agile prône un développement durable."
    },
    {
        id: 189,
        question: "Principe Agile sur la qualité ?",
        options: [
            "Flux continu",
            "Tests à tous niveaux",
            "Excellence technique constante",
            "Tout le monde teste"
        ],
        solution: "Excellence technique constante",
        explication: "La qualité vient de l’excellence technique continue."
    },
    {
        id: 190,
        question: "Principe Agile sur la simplicité ?",
        options: [
            "Comprendre la complexité",
            "Simplifier naturellement",
            "Réduire les coûts",
            "Maximiser le travail non effectué"
        ],
        solution: "Maximiser le travail non effectué",
        explication: "La simplicité est un principe clé Agile."
    },
    {
        id: 191,
        question: "Principe sur l’amélioration d’équipe ?",
        options: [
            "Réunion quotidienne",
            "Réfléchir et ajuster régulièrement",
            "Refactorisation constante",
            "Changer les rôles"
        ],
        solution: "Réfléchir et ajuster régulièrement",
        explication: "Cela correspond aux rétrospectives."
    },
    {
        id: 192,
        question: "Lequel n’est PAS un principe Agile ?",
        options: [
            "Satisfaire le client",
            "Respecter les délais à tout prix",
            "Accueillir le changement",
            "Livrer fréquemment"
        ],
        solution: "Respecter les délais à tout prix",
        explication: "Agile privilégie la valeur plutôt que les délais stricts."
    },
    {
        id: 193,
        question: "Objectif des '5 pourquoi' ?",
        options: [
            "Qui, quoi, où",
        ...
        solution: "Trouver la cause racine",
        explication: "La méthode cherche la cause profonde du problème."
    },
    {
        id: 194,
        question: "Objectif d’une auto-évaluation d’équipe ?",
        options: [
            "Fréquence des réunions",
            "Nombre de stories",
            "Prime annuelle",
            "Analyser comment l’équipe travaille ensemble"
        ],
        solution: "Analyser comment l’équipe travaille ensemble",
        explication: "L’auto-évaluation vise la performance collective."
    },
    {
        id: 195,
        question: "Comment analyser le risque d’une fonctionnalité ?",
        options: [
            "Plan de risques",
            "Avis des devs",
            "Réunion pré-mortem",
        ...
        solution: "Réunion pré-mortem",
        explication: "Le pré-mortem anticipe les raisons d’un échec."
    },
    {
        id: 196,
        question: "Quel outil pour trouver la cause racine d’un problème ?",
        options: [
            "Diagramme d’Ishikawa",
            "Analyse Kano",
            "Régression",
            "Graphiques multivariables"
        ],
        solution: "Diagramme d’Ishikawa",
        explication: "L’arête de poisson aide à identifier la cause racine."
    },
    {
        id: 197,
        question: "Que signifie un modèle hybride ?",
        options: [
            "Équipe mixte",
            "Produit à deux énergies",
            "Méthodes prédictives et adaptatives combinées",
            "Outils physiques et digitaux"
        ],
        solution: "Méthodes prédictives et adaptatives combinées",
        explication: "Un modèle hybride mélange cascade et Agile."
    },
    {
        id: 198,
        question: "Première étape de création d’une user story ?",
        options: [
            "Créer la carte",
            "Définir critères",
            "Discussion équipe",
        ...
        solution: "Créer la carte",
        explication: "Les 3C : Card, Conversation, Confirmation."
    },
    {
        id: 199,
        question: "Que doit contenir une user story ?",
        options: [
            "Risques",
            "Maquette",
            "Exigences, criticité, tests, critères d’acceptation",
            "Avis des parties prenantes"
        ],
        solution: "Exigences, criticité, tests, critères d’acceptation",
        explication: "Ces éléments définissent clairement la story."
    },
    {
        id: 200,
        question: "Après avoir créé la carte et les critères, que faire ?",
        options: [
            "Mettre sur Kanban",
            "Discuter avec les devs et confirmer le 'Done'",
            "Prioriser sprint",
            "Informer sponsor"
        ],
        solution: "Discuter avec les devs et confirmer le 'Done'",
        explication: "Deuxième et troisième C : Conversation et Confirmation."
    }
